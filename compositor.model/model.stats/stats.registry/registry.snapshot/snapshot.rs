...
use compositor_model_stats_registry_counter::{
    FENCE_FALLBACK, FENCE_KMS_INFENCE, FENCE_SYNCHRONOUS, FRAMES, VBLANKS,
};

use compositor_model_stats_registry_meta::meta;
pub use compositor_model_stats_registry_gpu::gpu::DeviceFormat;
...
pub fn snapshot() -> Snapshot {
    ...
    Snapshot {
        ...
        device_formats: compositor_model_stats_registry_gpu::gpu::device_formats(),
    }
}
