...
// The candidate fourccs and their VkFormats come from `format.universe`, which is
// the one place this compositor decides which formats it deals in. This crate is a
// DEVICE PROBE — it answers "what does this adapter say about them" — and must not
// have an opinion about which formats to ask about.
...
pub fn query_importable(
    ...
    unsafe {
        ...
        for (fourcc, vk_format) in compositor_kernel_graphic_format_catalog_base::catalog::probe_candidates() {
