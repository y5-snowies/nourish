...
impl WorkerSlot {
    pub fn allocate(
        ...
        let (fourcc, mods) = compositor_kernel_graphic_format_answer_base::answer::producer_formats(&ctx.formats, compositor_kernel_graphic_format_answer_base::answer::Consumer::IcedWorker);
