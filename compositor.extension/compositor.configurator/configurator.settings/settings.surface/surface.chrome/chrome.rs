...
pub fn render<'a>(
    ...
    ime: &'a Ime, keyboard: &'a KeyboardLayout, protocol_foreign: &'a str, protocol_foreign_all_worlds: bool,
    ...
    let body: El<'a> = match tab {
        ...
        Tab::Misc => misc::build(ime, keyboard, protocol_foreign, protocol_foreign_all_worlds),
