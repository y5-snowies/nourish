...
use compositor_pipeline_bundle_builtin_base::{builtins, props};
use compositor_pipeline_bundle_property_base::{apply_optimized, has_optimized};
use compositor_pipeline_compile_spirv_base::build_wgsl;
